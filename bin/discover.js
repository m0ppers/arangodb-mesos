...
var agency = "http://" + ARGUMENTS[0] + "/v2/keys/arango";
...
(function () {
  result = download(agency + "/Current/NewServers","",{"method":"GET"});
  ...
  result = download(agency + "/Target/MapLocalToID","",{"method":"GET"});
